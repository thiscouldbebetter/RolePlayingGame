...
class VisualAnimation2 {
    ...
    draw(universe, world, place, drawableAsEntity, display) {
        var drawable = drawableAsEntity;
        if (drawable.secondsSinceAnimationStarted == null) {
            drawable.secondsSinceAnimationStarted = 0;
        }
        var frameIndexCurrent = Math.floor(drawable.secondsSinceAnimationStarted * this.framesPerSecond);
